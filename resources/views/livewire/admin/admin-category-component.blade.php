                                        ...
                                        <td>
                                            <ul class="sclist">
                                                @foreach ($category->subCategories as $scategory)
                                                    <li><i class="i fa fa-caret-right"></i>{{ $scategory->name }} <a href="{{ route('admin.editcategory',['category_slug'=>$category->slug,'scategory_slug'=>$scategory->slug]) }}" class="slink"><i class="fa fa-edit"></i></a>
