                    ...
                    <div class="panel-body">
                        ...
                        <form action="" class="form-horizontal" wire:submit.prevent="updateCategory">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Category Name" class="form-control input-4" wire:model="name" wire:keyup="generateslug">
                                    @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Category Name" class="form-control input-4" wire:model="slug">
                                    @error('name')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <select name="" wire:model="category_id" id="" class="form-control">
