                    ...
                    <div class="panel-body">
                        ...
                        <form action="" class="form-horizontal" wire:submit.prevent="updateCoupon">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Coupon Code" class="form-control input-4" wire:model="code" >
                                    @error('code')
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Coupon Value" class="form-control input-4" wire:model="value" >
                                    @error('value')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Cart Value" class="form-control input-4" wire:model="cart_value" >
                                    @error('cart_value')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
