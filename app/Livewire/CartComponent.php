...
class CartComponent extends Component
{
    ...
    public function destroy($rowId)
    {
        ...
        // $this->emitTo('cart-count-component','refreshComponent');
        session()->flash('success_message','It has been removed successfully');
    }
    ...
    public function render()
    {
        ...
        return view('livewire.cart-component',['most_view_products'=>$most_view_products])->layout('layouts.base');
    }
}
